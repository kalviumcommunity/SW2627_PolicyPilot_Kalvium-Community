"""Token counting and cost estimation services for PolicyPilot RAG Assistant."""
...
def get_token_count(text: str, model_or_encoding: str = DEFAULT_ENCODING) -> int:
    ...
    If tiktoken fails or is unavailable, falls back to word-split estimation.
    """
    if not text:
        return 0
    try:
...
def estimate_cost(
    ...
    """Calculate input, output, and total estimated LLM cost in USD."""
